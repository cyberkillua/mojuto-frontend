    ...
    return (
        <nav className=" sm:px-[7rem] px-[2rem] py-[2rem] w-full">
            <div className="max-w-[1920px] mx-auto w-full flex justify-between items-center">
                <Logo />
                <div className="sm:flex  hidden gap-x-[2rem]">
                    {
                        navItems.map((navItem, idx) => {
                            return (
                                <Button asChild key={idx} className="font-rubik bg-off-white !px-[2rem] rounded-[3rem] !h-fit !py-[1.2rem] text-[#ffffff] text-[1.3rem] font-light backdrop-blur-[1rem]">
