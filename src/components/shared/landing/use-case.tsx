...
const UseCase = () => {
    const useCases = [
        {
            icons: <Tumb className="sm:mb-[3rem] mx-auto sm:mx-0 w-[50%] sm:w-[28rem] h-fit" />,
            description: <>Complete <br></br> Financial Analytics</>,
        },
        {
            icons: <Dia className="sm:w-[22.7rem] mx-auto sm:mx-0 w-[50%] h-fit sm:mt-[11.2rem] sm:h-[29.2rem] sm:mb-[3rem]" />,
            description: "Bulk Multi-Chain Analysis",
        },
        {
            icons: <Folder className="sm:w-[26rem] mx-auto sm:mx-0 w-[50%] h-fit sm:mb-[3rem]" />,
